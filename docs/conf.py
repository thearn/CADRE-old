...
_sys_path_add(['src', 'src/CADRE', 'src/CADRE/data', 'src/CADRE/Oddball', 'src/CADRE/test', 'src/CADRE/data/Power', 'src/CADRE/data/Solar', 'src/CADRE/data/Launch', 'src/CADRE/data/Comm'])
